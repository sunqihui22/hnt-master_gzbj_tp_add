 ...
 */
public class ProduceDataQuery extends BaseFragment {
    private static final String TAG = ProduceDataQuery.class.getSimpleName();
    private RecyclerView mRecyclerView;

    private PitchProduceQueryFragmentRecyclerViewAdapter mAdapter;
    private PageStateLayout mPageStateLayout;
    private PtrFrameLayout mPtrFrameLayout;
    private boolean isRegistered = false;
    private PitchProduceQueryFragmentListData itemData;

    private ParametersData mParametersData;
    private int lastVisibleItemPosition;
    private boolean isLoading;
    private List<PitchProduceQueryFragmentListData.DataEntity> listData;
    private Gson mGson;
    ...
    public static ProduceDataQuery newInstance(ParametersData mParametersData) {
        Bundle args = new Bundle();
        args.putSerializable(ConstantsUtils.PARAMETERS, mParametersData);
        ProduceDataQuery fragment = new ProduceDataQuery();
    ...
    private void initData() {
        ...
        //设置动画与适配器
        mSlideInLeftAnimationAdapter = new SlideInLeftAnimationAdapter(mAdapter = new PitchProduceQueryFragmentRecyclerViewAdapter(_mActivity, listData));
    ...
    public String createRefreshULR() {
        ...
        return URL.getLQProduceData(userGroupID, startDateTime, endDateTime, currentPage, equipmentID);
    ...
    public void onRefreshSuccess(String response) {
        ...
        if (!TextUtils.isEmpty(response)) {
            ...
            if (jsonObject.optBoolean("success")) {
                itemData = mGson.fromJson(response, PitchProduceQueryFragmentListData.class);
                if (null != itemData) {
...
//        ((CardView) view).setCardBackgroundColor(Color.parseColor("#0a000000"));
    ...
    private void jumpToLiQingDetailActivity(int position) {
        Intent intent = new Intent(_mActivity, PitchProduceQueryDetailActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("liqingdetail", listData.get(position));
