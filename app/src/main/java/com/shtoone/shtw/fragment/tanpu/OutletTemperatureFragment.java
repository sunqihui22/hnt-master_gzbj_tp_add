...
public class OutletTemperatureFragment extends BaseFragment {
...
//        setChartData();
        ...
        //设置动画与适配器
        SlideInLeftAnimationAdapter mSlideInLeftAnimationAdapter = new SlideInLeftAnimationAdapter(mAdapter = new OutletTempFragmentRecyclerViewAdapter(_mActivity, data.getData()));
